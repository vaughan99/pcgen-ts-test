import { type Campaign, CampaignsByNameSpec, type CampaignsByName } from '$lib/types';
...
export const storeCampaignsByName = async (campaignsByName: CampaignsByName) => {
...
export const openCampaignFilesystem = async (campaign: Campaign, filters?: os.Filter[]) =>
